...
foreach ($tipos as $tipo) {
    ...
    foreach ($categorias as $cat) {
        ...
        if (count($bens)) {
            // Monta tabela em HTML com layout fixo
            ...
            foreach ($bens as $bem) {
                ...
                $configuracao = nl2br(html_entity_decode($bem['configuracao'], ENT_QUOTES, 'UTF-8'));
                $local        = html_entity_decode($bem['localizacao'], ENT_QUOTES, 'UTF-8');
                ...
                $html .= '<tr>
                    ...
                    <td style="font-size:10px;">' . $configuracao . '</td>
                    <td style="font-size:10px; text-align:center;">' . $bem['quantidade'] . '</td>
                    <td style="font-size:10px;">' . $local . '</td>
                    <td style="font-size:10px; text-align:center;">' . $dataAqu . '</td>
                </tr>';
            }
